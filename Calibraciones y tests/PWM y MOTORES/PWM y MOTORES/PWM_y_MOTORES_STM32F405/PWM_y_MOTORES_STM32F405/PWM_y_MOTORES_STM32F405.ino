...
void PWM_GEN() {
  ...
  // Aprovechamos ese milisegundo para ejecutar la función receptor_RC que es donde se hace la lectura de la señal PPM, cuantas mas veces se ejecute mayor estabilidad
