...
void loop() {
  ...
  Mando_Roll      = map(Mando_canal[1], 600, 1600, -30, 30);    // Mapear pulso entre -30º y 30º
  Mando_Pitch     = map(Mando_canal[2], 600, 1596, -30, 30);    // Mapear pulso entre -30º y 30º
  Mando_Throttle  = map(Mando_canal[3], 600, 1600, 1000, 2000); // Mapear pulso entre 1000us y 2000us
  Mando_Yaw       = map(Mando_canal[4], 600, 1600, -30, 30);    // Mapear pulso entre -30º y 30º
  ...
  // Visualizar lecturas ya escaladas por canal serie (esto se ha comentado para la foto)
