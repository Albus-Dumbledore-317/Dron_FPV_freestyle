...
// Variables modos de vuelo:
float grados_ilimitados = 180; // Esto es para el modo acrobatico. (Revisar si estos serian los correctos para volar o se deberian eliminar)
float grados_estable = 15; // Para un modo estable limitado a 15 grados de inclinación.
